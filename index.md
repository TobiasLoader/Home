...
<ins>A note regarding my personal statement:</ins> the reinforcement learning neural network referenced in my personal statement and viewable [below](#1-training-a-reinforcement-neural-network) under the 'Projects In Progress’ section, is a continuation of the supervised deep neural network described here.

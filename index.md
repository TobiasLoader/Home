...
NB: I referred to a continuation of this project in my personal statement, namely a [reinforcement learning neural network](#1-training-a-reinforcement-neural-network), which is described below under the 'Projects In Progress’ section. 
